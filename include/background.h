...
struct background
{
  ...
  short has_varying_const; /**< presence of variation of fundamental constants? */

  //@}

  /**
   *@name - related to varying fundamental constants
   */

  //@{

  double * pvecvc; /**< Table of varying fundamental constants */
  int index_vc_alpha;
  int index_vc_me;
  int index_vc_G;
  int vc_size;

  double varying_alpha; /**< Value of varying alpha in the early universe (if constant there)*/
  double varying_me; /**< Value of varying me in the early universe (if constant there)*/
  double varying_G; /**< Value of varying G in the early universe (if constant there)*/
